...
const ThreeMonthsGoalHeaderEditor: React.FC<ThreeMonthsGoalHeaderType> = ({
  ...
  const [editedGoalText, setEditedGoalText] = useState<string | undefined>(
    goalText
  );
  const [editedExplanationText, setEditedExplanationText] = useState<
    string | undefined
  >(explanationText);
  ...
  const handleExplanationTextChange = (
